                        ...
                        >
                            ...
                            <div className="grid grid-rows-2 grid-flow-col gap-4 sm:gap-6">
                                {cat.skills.map(({ name, icon: Icon, color }) => (
                                    <div
                                        key={name}
                                        className="skill-card flex flex-col items-center justify-center gap-3 w-32 h-32 sm:w-40 sm:h-40 rounded-2xl sm:rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md p-4 text-white/90 text-center hover:bg-white/[0.08] hover:border-white/30 hover:shadow-[0_10px_30px_rgba(0,0,0,0.5)] hover:-translate-y-1 transition-all duration-300 group cursor-default"
                                    >
                                        <div className={`text-5xl sm:text-6xl ${color} transition-transform duration-300 group-hover:scale-110 group-hover:-translate-y-0.5 drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]`}>
                                            <Icon />
                                        </div>
