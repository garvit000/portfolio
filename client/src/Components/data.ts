...
const Data: ProjectItem[] = [
    ...
    },
    {
        ...
        description: "Prognosis Care is a comprehensive healthcare platform designed to connect patients with doctors, manage appointments, and provide seamless medical services.",
