...
function Footer() {
  return (
    <div className="bg-gradient-to-b from-amber-600 to-gray-800 mx-auto text-white w-screen h-screen flex flex-col pt-22">
      <div className="flex-grow flex flex-col">
        ...
        <div className="mx-auto md:mr-20 md:self-end md:-mt-20 mt-8 rounded-2xl p-5 bg-gradient-to-r from-purple-400 to-emerald-500 max-w-xs">
          ...
          <div className="flex justify-between pt-3 cursor-pointer">
            <a href="https://github.com/garvit000" target="_blank" rel="noopener noreferrer">
              <FaGithub className="text-3xl text-gray-300 hover:text-4xl transition-all duration-300" />
            </a>
            <a href="https://linkedin.com/in/garvit-s-r" target="_blank" rel="noopener noreferrer">
              <FaLinkedin className="text-3xl text-blue-500 hover:text-4xl transition-all duration-300" />
            </a>
            <a href="https://instagram.com/garvit_s_r" target="_blank" rel="noopener noreferrer">
